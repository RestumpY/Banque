        ...
        private void bouton_Click(object sender, EventArgs e)
        {
           ...
           Compte c = lstcpt[j];
            ...
            if (bouton.Text == "Valider le crédit")
                ...
                {
                    if (!c.débiter(Convert.ToDouble(tb.Text))) { MessageBox.Show("attention débit interdit !"); }

                    else { monManager.updateSolde(c); }
                ...
                if (bouton.Text == "Valider le découvert")
                {
                    ...
                    try
                    {
                        c.setDecouv(Convert.ToDouble(tb.Text));
                        monManager.updateDecouvert(c);
